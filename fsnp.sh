...
java -jar $GATK \
    ...
    --filterExpression "QD < 2.0 || FS > 60.0 || MQ < 34.0 || SOR > 5.0 || MQRankSum < -4.0 || ReadPosRankSum < -3.0 || InbreedingCoeff < -0.8" \
    --filterName "QD:2,FS:60,MQ:34,SOR:5,MQRS:-4,RPRS:-3,IC:-0.8" \
    -o $GLOBAL_SCRATCH/filtered_snps.vcf
